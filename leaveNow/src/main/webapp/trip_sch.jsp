...
<section>
	...
	<div class="row">
		<div class="col-md-9 col-md-offset-3">
			<div class='row'>
				<!-- 여행일정 작성 옵션 -->
				<input type="number" id="num-day" value="1" style="margin-bottom: 0;"/><input type="button" value="입력" id="dayInput"/>
				<button >저장하기</button>
			</div>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=eebdba1d92f001c45adfbf8e887c0fa2&libraries=services"></script>
<script>
