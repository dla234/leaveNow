					...
					<div class="row">
						<div id="right_content_list">
							<ul>
								...
								<a id="SC4" href="#">
									<li id="right_content_list_6">
										<span>학교</span>
									</li>
								</a>
								<a id="PK6" href="#">
									<li id="right_content_list_7">
										<span>주차장</span>
									</li>
								</a>
								<a id="SW8" href="#">
									<li id="right_content_list_8">
										<span>지하철역</span>
									</li>
								</a>
								<a id="CF7" href="#">
									<li id="right_content_list_9">
										<span>카페</span>
									</li>
								</a>
								<a id="HP8" href="#">
									<li id="right_content_list_10">
										<span>병원</span>
									</li>
								</a>
							</ul>
