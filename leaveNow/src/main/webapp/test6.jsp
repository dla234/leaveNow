    ...
    var $target=$("#"+ev.target.id);
   	...
   	if(data.includes("drag")){
   	    ...
   	    ev.target.appendChild(nodeCopy);
   	 	...
   	 	$("#"+nodeCopy.id).css("z-index","2");
   	 	//div 내부 값 접근해서 resize 걸기
   	 	$("#"+nodeCopy.id).children().css("resize","vertical").css("overflow","overlay").css("z-index","4");
...
$(document).ready(function() { 
	...
	/* $("div.inner").resizable({
	  	 ...
	  	 create: function( event, ui ) {
	           ...
	           $(".ui-resizable-s").css("cursor","ew-resize");
	       },
