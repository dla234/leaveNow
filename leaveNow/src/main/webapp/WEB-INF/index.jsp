...
<body data-spy="scroll" data-target=".navbar">
					...
					<ul class="nav navbar-nav ">
					  ...
					  <div class="nav navbar-nav ">
					  	<div class="dropdown" style="height: 30px;">
        					<button style=" margin-top: 11px; background-color: white; border-style: none;" type="button" class="glyphicon glyphicon-user" data-toggle="dropdown">
        					MyPage 
        					</button>
	...
	<header id="top-section" class="fullbg">
		<div class="jumbotron">
				...
				<div class="carousel-inner">
					...
					<div class="active item" id="slide_1">
						<div class="carousel-content">
							...
							<br /> <a href="#" class="buttonyellow animated fadeInLeftBig"><i
								class="glyphicon glyphicon-calendar"></i>&nbsp; 여행 일정 보기</a> 
					...
					<div class="item" id="slide_2">
						<div class="carousel-content">
							...
							<br /> <a href="#" class="buttoncolor animated fadeInRightBig"><i
								class="fa fa-link"></i>&nbsp; 이용방법</a>
			...
			<button class="left carousel-control" href="#carousel_intro"
				data-slide="prev" data-start="opacity: 0.6; left: 0%;"
				data-250="opacity:0; left: 5%;">
				<i class="glyphicon glyphicon-chevron-left"></i>
			</button>
			<button class="right carousel-control" href="#carousel_intro"
				data-slide="next" data-start="opacity: 0.6; right: 0%;"
				data-250="opacity:0; right: 5%;">
		...
		<div class="container ">
			<div class="row">
				<div class="text-center color-white col-sm-12 col-lg-12">
					...
					<p>© Your Website.com. Template by WowThemes.net</p>
					<p>
						<a href="http://www.wowthemes.net/premium-themes-templates/">Official
							Website</a> | <a href="http://www.wowthemes.net/support/">Theme
							Support</a> | <a
							href="http://www.wowthemes.net/frequently-asked-questions/">F.A.Q.</a>
					</p>
				</div>
			</div>
		</div>
	...
	<script
		...
		<script src="resources/js/jquery.localscroll-1.2.7-min.js" type="text/javascript">
	</script>
	<script src="resources/js/jquery.scrollTo-1.4.6-min.js"
					...
					<div class="form-group">
						...
						<div data-toggle="buttons">
							...
							<div id="demo" class="collapse">
								<div class="col-xs-12">
									<br>
									<textarea style="background-color: white; resize: none"
...
~~~~~~~~~~~~~~~~~ 이용약관 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 이용약관 ~~~~~~~~~~~~~~~~~
                ...
                <div class="modal-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <button class="btn btn-danger" type="submit" style="border-radius: 3px">가입취소<i class="fa fa-times spaceLeft"></i></button>
                    </div>
                </div>
            </div>
        </div>
